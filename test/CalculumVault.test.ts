...
describe("Check Standard Work Flow of the Value Based on Excel", function () {
  const EPOCH_START = moment().utc(false).unix();
  let currentEpoch: moment.Moment;
  let nextEpoch: moment.Moment;
  before(async () => {
    [
    ...
    const response = await fetch("http://localhost:3000/set/contract", {
      method: "POST",
      body: JSON.stringify({
        contractAddress: Calculum.address,
        contractOracleAddress: Oracle.address,
      }),
    ...
    expect(data.contractOracleAddress).to.equal(Oracle.address);
    // Allowance the Contract in Stable Coin
    await USDc.connect(deployer).approve(Calculum.address, 100000000 * 10 ** 6);
    await USDc.connect(alice).approve(Calculum.address, 100000000 * 10 ** 6);
    await USDc.connect(bob).approve(Calculum.address, 100000000 * 10 ** 6);
  ...
  it("2.- Verification of Sequence of First Epoch (Epoch 0)", async () => {
    ...
    console.log("TimeStamp Next Epoch: ", nextEpoch.utc(false));
    // Move to after the Maintenance Time Post Maintenance
    const move1: moment.Moment = moment(timestamp * 1000);
    await network.provider.send("evm_setNextBlockTimestamp", [
      parseInt(move1.add(maintTimeAfter * 6, "s").format("X")),
    ]);
    await network.provider.send("evm_mine", []);
    console.log(
    ...
    console.log("Setting Epoch Duration: ", epochDuration);
    ...
    console.log("Setting Maximal Deposit: ", 10000 * 10 ** 6);
    ...
    console.log("Set Asset Value, First Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 1500000000,
        percentage: 0,
    ...
    const data = await response.json();
    console.log(data);
    console.log("Snooze for 1 min before First Finalize Epoch");
    await snooze(60000);
    // Getting Current Epoch and Next Epoch
    console.log(
      `Number of Current Epoch: ${parseInt(
    ...
    await expect(Calculum.connect(transferBotRoleAddress).dexTransfer())
      .to.emit(USDc, "Transfer")
      .withArgs(Calculum.address, transferBotWallet.address, 1500 * 10 ** 6);
  ...
  it("3.- Verification of Sequence of Second Epoch (Epoch 1)", async () => {
    ...
    const move5: moment.Moment = moment(
      Math.floor((await ethers.provider.getBlock("latest")).timestamp) * 1000
    );
    await network.provider.send("evm_setNextBlockTimestamp", [
      parseInt(move5.add(maintTimeAfter + 60).format("X")),
    ]);
    await network.provider.send("evm_mine", []);
    console.log(
    ...
    console.log("Set Asset Value, Second Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 1350000000,
    ...
    const data = await response.json();
    console.log(data);
    console.log("Snooze for 1 min before Second Finalize Epoch");
    await snooze(60000);
    // Getting Current Epoch and Next Epoch
    console.log(
      `Number of Current Epoch: ${parseInt(
  ...
  it("4.- Verification of Sequence of Third Epoch (Epoch 2)", async () => {
    ...
    console.log("Set Asset Value, third Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 1282226400,
    ...
    console.log("Snooze for 1 min before Third Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
  ...
  it("5. Verification of Sequence of Fourth Epoch (Epoch 3)", async () => {
    ...
    console.log("Set Asset Value, Fourth Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 1871065245,
    ...
    console.log("Snooze for 1 min before Fourth Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
  ...
  it("6. Verification of Sequence of Fifth Epoch (Epoch 4)", async () => {
    ...
    console.log("Set Asset Value, Fifth Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 3315226114,
    ...
    console.log("Snooze for 1 min before Fifth Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
  ...
  it("7. Verification of Sequence of Sixth Epoch (Epoch 5)", async () => {
    ...
    console.log("Set Asset Value, Sixth Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 3455486910,
    ...
    console.log("Snooze for 1 min before Sixth Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
  ...
  it("8. Verification of Sequence of Seventh Epoch (Epoch 6)", async () => {
    ...
    console.log("Set Asset Value, Seventh Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 2222042863,
    ...
    console.log("Snooze for 1 min before Seventh Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
  ...
  it("9. Verification of Sequence of Eighth Epoch (Epoch 7)", async () => {
    ...
    console.log("Set Asset Value, Eighth Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 2107028453,
    ...
    console.log("Snooze for 1 min before Eighth Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
  ...
  it("10. Verification of Sequence of Ninth Epoch (Epoch 8)", async () => {
    ...
    console.log("Set Asset Value, ninth Epoch");
    const response = await fetch("http://localhost:3000/set/valueAsset", {
      method: "POST",
      body: JSON.stringify({
        assets: 2660984944,
    ...
    console.log("Snooze for 1 min before Ninth Finalize Epoch");
    await snooze(60000);
    // Finalize the Epoch
    await Calculum.connect(transferBotRoleAddress).finalizeEpoch();
    console.log(
