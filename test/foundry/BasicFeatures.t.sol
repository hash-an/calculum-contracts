...
contract BasicFeaturesTest is Test {
    ...
    string constant public NAME = "CalculumUSDC1";
    string constant public SYMBOL = "calcUSDC1";
    ...
    function testInitialValues() public {
        ...
        assertEq(abi.encodePacked(vault.symbol()), abi.encodePacked(SYMBOL), "init: wrong token symbol");
        ...
        assertEq(vault.MAINTENANCE_PERIOD_PRE_START(), 60 minutes, "init: wrong maintenance pre start");
        assertEq(vault.MAINTENANCE_PERIOD_POST_START(), 30 minutes, "init: wrong maintenance post start");
